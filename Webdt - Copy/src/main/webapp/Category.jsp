<%@ page contentType="text/html;charset=UTF-8" language="java" %><!--phải có dòng này thì jsp mới chạy đc-->
        ...
        <div class="row">
            <div class="col-md-6 col-sm-10">
                <div class="single-promo promo1">
                    ...
                    <li><a href="ProductListController?id=1">Iphone</a></li>
                </div>
            </div>
            <div class="col-md-6 col-sm-10">
                <div class="single-promo promo2">
                    <i class="fa fa-gift"></i>
                    <li><a href="ProductListController?id=2">SamSung Galaxy</a></li>
                </div>
            </div>
            <div class="col-md-6 col-sm-10">
                <div class="single-promo promo3">
                    <i class="fa fa-headphones"></i>
                    <li><a href="ProductListController?id=3">Headphone</a></li>
                </div>
            </div>
            <div class="col-md-6 col-sm-10">
                <div class="single-promo promo4">
                    <i class="fa fa-gift"></i>
                    <li><a href="ProductListController?id=4">Backup Charger</a></li>
                </div>
            </div>
        </div>
    </div>
