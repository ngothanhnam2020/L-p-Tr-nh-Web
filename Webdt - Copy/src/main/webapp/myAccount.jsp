...
<div class="total_myAccount">
    <form action="/Webdt/AccoutUpdate" method="post">
        <div class="account">
            <img src="img/istockphoto-1300845620-170667a.jpg" alt="Avatar" class="avatar">
            <p class="mainP">Name:</p>
            <input type="text" placeholder="Full Name" class="text" value="${auth.userName}" name="userName">
            <p class="mainP">Email:</p>
            <input type="email" placeholder="Email" class="text" value="${auth.email}" name="email">
            <p class="mainP">Phone Number:</p>
            <input type="tel" class="text" placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}"
                   required value="${auth.phone_number}" name ="phone_number">
            <p class="mainP">Address:</p>
            <input type="text" placeholder="Address" class="text" value="${auth.address}" name ="address">
        ...
        <div class="AddressDelt">
            <div class="first">
                <div class="city">
                    <p class="subP">City:</p>
                    <input type="text" class="text_address" value="${auth.city}" name ="city">
                </div>
                <div class="state">
                    <p class="subP">State:</p>
                    <input type="text" class="text_address" value="${auth.state}" name ="state">
                </div>
            </div>
            <div class="second">
                <div class="zCode">
                    <p class="subP">Zip code:</p>
                    <input type="text" class="text_address" value="${auth.zip_code}" name="zip_code">
                </div>
                <div class="country">
                    <p class="subP">Country:</p>
                    <input type="text" class="text_address" value="${auth.country}" name ="country">
                </div>
            </div>
        </div>
