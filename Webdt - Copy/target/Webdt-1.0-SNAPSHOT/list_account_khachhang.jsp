        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/Webdt/Customer">User Manager</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <c:forEach items="${AdminUser}" var="user">
                <tr class="cart_item">
                    <td class="product-remove">
                        <a title="Remove this item" class="remove" pid="${user.id}" href="/Webdt/Customer" >×</a>
                    </td>
...
<%--                        <span class="changeQuantity" pid="${product.id}" >${product.totalMoney}</span>--%>
                        <a value="Checkout" class="checkout-button button alt wc-forward" href="/Webdt/ShowAdminUser?id=${user.id}">Update</a>
                    </td>
                </tr>
            </c:forEach>
            <tr>
                <td class="actions" colspan="6">
                    <a id ="button"value="Checkout" class="checkout-button button alt wc-forward" href="/Webdt/Customer">Refest</a>
                    <a value="Checkout" class="checkout-button button alt wc-forward" href="user.jsp">ADD</a>
                </td>
            </tr>
...
<script>
    ...
    $(document).ready( function () {
        ...
        <% String data=session.getAttribute("AdminUser") ==null?"{}":new Gson().toJson(session.getAttribute("AdminUser")); %>
