            ...
            <div class="col-sm-6 col-right">
                ...
                <div class="shopping-item">
                    <a href="/Webdt/cart">Cart - $<span class="cart-amunt">${cart.totalPrice}</span> <i
                            class="fa fa-shopping-cart"></i> <span class="product-count">${cart.productList.size()}</span></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/Webdt/Checkout">Checkout</a></li>
...
<%--                    <div class="thubmnail-recent">--%>
<%--                        <img src="img/iphone8plus.jpg" class="recent-thumb" alt="">--%>
<%--                        <h2><a href="">Iphone 8 Plus</a></h2>--%>
<%--                        <div class="product-sidebar-price">--%>
<%--                            <ins>7.900.000 VND</ins> <del>9.000.000 VND</del>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                    <div class="thubmnail-recent">--%>
<%--                        <img src="img/iphone632gb.jpg" class="recent-thumb" alt="">--%>
<%--                        <h2><a href="">Iphone 6 32GB</a></h2>--%>
<%--                        <div class="product-sidebar-price">--%>
<%--                            <ins>3.990.000 VND</ins> <del>5.000.000 VND</del>--%>
<%--                        </div>--%>
<%--                    </div>--%>
<%--                    <div class="thubmnail-recent">--%>
<%--                        <img src="img/iphonese.jpg" class="recent-thumb" alt="">--%>
<%--                        <h2><a href="">Iphone SE</a></h2>--%>
<%--                        <div class="product-sidebar-price">--%>
<%--                            <ins>12.500.000 VND</ins> <del>15.000.000 VND</del>--%>
<%--                        </div>--%>
<%--                    </div>--%>
                    </c:forEach>
                </div>
                            ...
                            <div id="order_review" style="position: relative;">
                                <table class="shop_table">
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>Cart Subtotal</th>
                                        <td><span class="amount">${price}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="order-total">
                                        <th>Order Total</th>
                                        <td><strong><span class="amount">${price}</span></strong> </td>
                                    </tr>
                                ...
                                <div id="payment">
                                    ...
                                    <div class="form-row place-order">
                                        ...
                                        <a  class="checkout-button button alt wc-forward" href="/Webdt/cart-checkOut">PLACE ORDER</a>
