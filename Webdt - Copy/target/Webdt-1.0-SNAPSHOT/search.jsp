        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-right">
                ...
                <div class="shopping-item">
                    <a href="cart.html">Cart - $<span class="cart-amunt">${cart.totalPrice}</span> <i
...
<div class="search-area">
    ...
    <div class="container">
        <div class="row">
            ...
            <c:forEach items="${productSearch}" var="p">
                    ...
                    <div class="single-shop-product">
                        ...
                        <div class="product-option-shop">
                            <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70"
                               rel="nofollow" href="Cart-add?id=${p.id}">Add to cart</a>
                        </div>
                    </div>
                </div>
            </c:forEach>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        <ul class="pagination">
                            <li><a href="SearchController?page=<%=pagePrevious%>&searchName=${searchName}">Previous</a></li>
                            <c:forEach begin="1" end="${endPage}" var="i">
                                <c:choose>
                                    <c:when test="${pageIsSelected == i}">
                                        <li>
                                            <a href="SearchController?page=${i}&searchName=${searchName}"
                                               class="selected">${i}</a>
<%--                                            <% pageNow = ${i} %>--%>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                        <li>
                                            <a href="SearchController?page=${i}&searchName=${searchName}">${i}</a>
                                        </li>
                                    </c:otherwise>

                                </c:choose>
                            </c:forEach>
                            <li><a href="SearchController?page=<%=pageNext%>&searchName=${searchName}">Next</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
